    ...
    <body>
        <div class="login-dark">
            ...
            <form class="form-horizontal" role="form" method="POST" action="/auth/register">
                ...
                <h2 class="sr-only">{{ trans('messages.register') }} Form</h2>
                <div class="illustration"><i class="icon ion-ios-locked-outline"></i></div>
                <div class="form-group"><input type="name" placeholder="Name" class="form-control" name="name" value="{{ old('name') }}"></div>
                ...
                <div class="form-group"><input placeholder="Password Confirm" type="password" class="form-control" name="password_confirmation"></div>
                <div class="form-group"><button class="btn btn-primary btn-block" type="submit">{{ trans('messages.register') }}</button></div>
