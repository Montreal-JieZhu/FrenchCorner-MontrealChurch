        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="#">UnTranslated</a></li>
                    <li><a href="{{ url('/Translated') }}">{{ trans('messages.history') }}</a></li>
                </ul>
                ...
                <div class="col-sm-8">
                    <div class="container" id="section1">
                        ...
                        <div class="container col-sm-10">
                            ...
                            <h4 class="alert alert-info">Please translate it into English:</h4>
                            ...
                            <form role="form" name="questionForm" action="{{url('/RESTFullQuestionsAPI')}}" method="POST" onsubmit=" return submitQuestionForm(this)">
                                ...
                                <div class="form-group">
                                    <textarea  class="form-control" rows="4" name="Translation" required></textarea>
            ...
            function submitQuestionForm(formElement) {
                ...
                if (textareaElement.attr('disabled') === undefined) {
                    ...
                    $.post(url, data, function (response, status) {
                        ...
                        alert("Your translation has been saved!");
