                        ...
                        <div class="container col-sm-10">
                            ...
                            <form role="form" name="questionForm" action="{{url('/RESTFullQuestionsAPI/answer')}}" method="POST" onsubmit=" return submitQuestionForm(this)">
                                ...
                                <div class="form-group">
                                    <textarea disabled="true"  class="form-control" rows="4" name="Answer" required>{{ $gr->answerEn }}</textarea>
                    ...
                    <div  class="container" id="section2">
                        ...
                        <div class="container col-sm-10">
                            ...
                            <form role="form" name="questionForm" action="{{url('/RESTFullQuestionsAPI/answer')}}" method="POST" onsubmit=" return submitQuestionForm(this)">
                                {{ csrf_field() }}
                                <div class="form-group">
                                    <textarea disabled="true"  class="form-control" rows="4" name="Answer" required>{{ $wg->answerEn }}</textarea>
                                    <!--<input type="text" class="form-control" name="Translation">-->
                                </div>
                                <div class="form-group">
                    ...
                    <div  class="container" id="section3">
                        ...
                        <div class="container col-sm-10">
                            ...
                            <form role="form" name="questionForm" action="{{url('/RESTFullQuestionsAPI/answer')}}" method="POST" onsubmit=" return submitQuestionForm(this)">
                                {{ csrf_field() }}
                                <div class="form-group">
                                    <textarea disabled="true"  class="form-control" rows="4" name="Answer" required>{{ $ol->answerEn }}</textarea>
                                    <!--<input type="text" class="form-control" name="Translation">-->
                                </div>
                                <div class="form-group">
                    ...
                    <div  class="container" id="section4">
                        ...
                        <div class="container col-sm-10">
                            ...
                            <form role="form" name="questionForm" action="{{url('/RESTFullQuestionsAPI/answer')}}" method="POST" onsubmit=" return submitQuestionForm(this)">
                                {{ csrf_field() }}
                                <div class="form-group">
                                    <textarea disabled="true"  class="form-control" rows="4" name="Answer" required>{{ $lg->answerEn }}</textarea>
                                    <!--<input type="text" class="form-control" name="Translation">-->
                                </div>
                                <div class="form-group">
