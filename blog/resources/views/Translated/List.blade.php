...
<html>
    ...
    <body data-spy="scroll" data-target="#myScrollspyList" data-offset="0">
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="{{ url('/UnTranslated') }}">UnTranslated</a></li>
                    <li class="active"><a href="#">{{ trans('messages.history') }}</a></li>
                </ul>
                <ul class="nav navbar-nav navbar-right">
                    <li>
                        @unless (Auth::check())
                        <a id="loginoutBtn" href="{{ url('/UnTranslated') }}">
                ...
                <div class="col-sm-8">
                    <div class="container" id="section1">
                        ...
                        <div class="container col-sm-10">
                            ...
                            <p class="well well-lg">{{ $gr->questionOrg }}</p>
                            <h4 class="alert alert-info">Translation:</h4>
                            <!--<form role="form" name="questionForm" action="/RESTFullQuestionsAPI" method="POST">-->
                            <form role="form" name="questionForm" action="{{url('/RESTFullQuestionsAPI')}}" method="POST" onsubmit=" return submitQuestionForm(this)">
                                {{ csrf_field() }}
                                <div class="form-group">
                                    <textarea disabled="true"  class="form-control" rows="4" name="Translation" required>{{ $gr->questionEn }}</textarea>
                                ...
                                <div class="col-sm-9">
                                    <button type="button" onclick="deleteQuestion(this)" class="btn btn-danger" id="{{'btnDel_' . $gr->id}}">{{ trans('messages.delete') }}</button>
                                    <button type="button" onclick="enableEditBox(this)" class="btn btn-primary" id="{{'btnEdit_' . $gr->id}}">{{ trans('messages.edit') }}</button>
                                </div>
                                <div class="col-sm-3">
                    ...
                    <div  class="container" id="section2">
                        ...
                        <div class="container col-sm-10">
                            ...
                            <p class="well well-lg">{{ $wg->questionOrg }}</p>
                            <h4 class="alert alert-info">Translation:</h4>
                            <!--<form role="form" name="questionForm" action="/RESTFullQuestionsAPI" method="POST">-->
                            <form role="form" name="questionForm" action="{{url('/RESTFullQuestionsAPI')}}" method="POST" onsubmit=" return submitQuestionForm(this)">
                                {{ csrf_field() }}
                                <div class="form-group">
                                    <textarea disabled="true" class="form-control" rows="4" name="Translation" required>{{ $wg->questionEn }}</textarea>
                                    <!--<input type="text" class="form-control" name="Translation">-->
                                </div>
                                <div class="form-group">
                    ...
                    <div  class="container" id="section3">
                        ...
                        <div class="container col-sm-10">
                            ...
                            <p class="well well-lg">{{ $ol->questionOrg }}</p>
                            <h4 class="alert alert-info">Translation:</h4>
                            <!--<form role="form" name="questionForm" action="/RESTFullQuestionsAPI" method="POST">-->
                            <form role="form" name="questionForm" action="{{url('/RESTFullQuestionsAPI')}}" method="POST" onsubmit=" return submitQuestionForm(this)">
                                {{ csrf_field() }}
                                <div class="form-group">
                                    <textarea disabled="true"  class="form-control" rows="4" name="Translation" required>{{ $ol->questionEn }}</textarea>
                                    <!--<input type="text" class="form-control" name="Translation">-->
                                </div>
                                <div class="form-group">
                    ...
                    <div  class="container" id="section4">
                        ...
                        <div class="container col-sm-10">
                            ...
                            <p class="well well-lg">{{ $lg->questionOrg }}</p>
                            <h4 class="alert alert-info">Translation:</h4>
                            <!--<form role="form" name="questionForm" action="/RESTFullQuestionsAPI" method="POST">-->
                            <form role="form" name="questionForm" action="{{url('/RESTFullQuestionsAPI')}}" method="POST" onsubmit=" return submitQuestionForm(this)">
                                {{ csrf_field() }}
                                <div class="form-group">
                                    <textarea disabled="true"  class="form-control" rows="4" name="Translation" required>{{ $lg->questionEn }}</textarea>
                                    <!--<input type="text" class="form-control" name="Translation">-->
                                </div>
                                <div class="form-group">
        ...
        <h1>Sorry, You are not a Translator!</h1>
        @endcan
